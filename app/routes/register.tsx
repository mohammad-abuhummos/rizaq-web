...
export default function Register() {
  ...
  useEffect(() => {
    const initRegistration = async () => {
      try {
        // Check if we already have a registration ID
    ...
    try {
      ...
      if (response.success) {
        ...
        if (response.data?.devOtp) {
          ...
          // You can show this in a toast/alert if needed
        }
  ...
  // Show loading only during initial registration ID fetch, but show form if it fails
  if (loadingRegistrationId) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600" style={{ fontFamily: 'Cairo, sans-serif' }}>
                انضم إلى منصة رزق الزراعية وابدأ رحلتك
              </p>
            </div>
              ...
              <div>
                ...
                <div className="flex flex-row-reverse border rounded-lg bg-white overflow-hidden">
                  <input
                    ...
                    className={`flex-1 px-4 py-3 text-right border-none focus:outline-none focus:ring-2 ${
                      errors.phone
                        ? "focus:ring-red-500"
